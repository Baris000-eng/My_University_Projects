...
public class TxtSaveLoadAdapter implements ISaveLoadAdapter{
	...
	public void saveGame(String gameName) {
		try {
			Files.write(Paths.get("savedWorlds.txt"), (GameInfo.currentPlayer+"\n").getBytes(), StandardOpenOption.APPEND);
			Files.write(Paths.get("savedWorlds.txt"), (gameName+"\n").getBytes(), StandardOpenOption.APPEND);
			Files.write(Paths.get("savedWorlds.txt"), (GameInfo.sphere+"\n").getBytes(), StandardOpenOption.APPEND);
			Files.write(Paths.get("savedWorlds.txt"), (GameInfo.currentPlayer.getMagicalAbilities()[0]+" "+
					GameInfo.currentPlayer.getMagicalAbilities()[1]+ " " +
					GameInfo.currentPlayer.getMagicalAbilities()[2]+ " " +
					GameInfo.currentPlayer.getMagicalAbilities()[3]+"\n").getBytes(), StandardOpenOption.APPEND);
